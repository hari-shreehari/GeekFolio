...
export const ContainerScroll = ({
  ...
  return (
    <div className="h-[40rem] md:h-[60rem] flex items-center justify-center relative p-2 md:p-20" ref={containerRef}>
      ...
      >
        <Card rotate={rotate} translate={translate} scale={scale} titleComponent={titleComponent} />
      </div>
    </div>
  )
}
...
export const Card = ({
  ...
  return (
    ...
    >
      <div className="bg-gray-100 h-full w-full rounded-2xl overflow-hidden p-4 flex items-center justify-center">
        {titleComponent}
      </div>
    </motion.div>
  )
