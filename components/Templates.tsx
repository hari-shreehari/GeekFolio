...
const templates: Template[] = [
  {
    ...
    category: "Minimal",
    description:
      "Clean and modern design focusing on simplicity and content. Perfect for professionals who want to highlight their work without distractions.",
    color: "bg-gray-50",
  ...
  },
  {
    ...
    category: "Tech",
    description:
      "Modern and tech-focused design with a dark mode option. Ideal for developers, IT professionals, and tech startups.",
    color: "bg-green-50",
  ...
  },
  {
    ...
    category: "Creative",
    description:
      "Vibrant and expressive design that stands out. Ideal for artists, designers, and creatives.",
    color: "bg-purple-50",
  ...
  },
  {
    ...
    category: "Business",
    description:
      "Sleek and professional layout tailored for business executives and corporate professionals.",
    color: "bg-blue-50",
...
const ColorfulTemplateSelection: React.FC<TemplateSelectorProps> = ({
  onSelectTemplate,
}) => {
      ...
      <div className="space-y-24">
        {filteredTemplates.map((template, index) => (
          ...
          >
            ...
            <div
              className={`w-full md:w-1/2 p-6 flex flex-col justify-between ${index % 2 === 0 ? "md:pl-12" : "md:pr-12"}`}
            >
              <div>
                <h2 className={`text-3xl font-bold mb-2 ${template.textColor}`}>
                  {template.name}
                </h2>
                <Badge className={`mb-4 ${template.accentColor} text-white`}>
                  {template.category}
                </Badge>
                <p className={`text-lg mb-6 ${template.textColor}`}>
